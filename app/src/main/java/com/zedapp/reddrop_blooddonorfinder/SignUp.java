...
public class SignUp extends AppCompatActivity {
    String ability,fname,lname,dateofbirth,city,address,email,cnumber,enumber,bloodgroup,password;
    TextInputLayout fnameet,lnameet,addresset,emailet,cnumberet,enumberet,passwordet;
    RadioGroup abilityrd,bloodgrouprd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityet.setOnClickListener(v -> {
            ...
            listViewd.setOnItemClickListener((parent, view, position, id) -> {
        ...
        signup.setOnClickListener(v -> {
            if (ability.equals("")){
                Toast.makeText(SignUp.this,"Please Select Donor Ability Option",Toast.LENGTH_LONG).show();
            }
        ...
        abilityrd = findViewById(R.id.ability);
        abilityrd.setOnCheckedChangeListener((group, checkedId) -> {
            RadioButton dnr = (RadioButton) group.findViewById(checkedId);
            if (null != dnr && checkedId > -1) {
                ability = dnr.getText().toString();
            }
